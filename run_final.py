# run_final.py - Versión definitiva para producción
import os
import sys
...
print("="*60)
print("🚀 SISTEMA RRHH DIGITAL - MODO PRODUCCIÓN - MIRIAN Y GONZALEZ")
print("="*60)
...
try:
    serve(app, 
          ...
          port=5000,           # Puerto
          threads=8,           # Hilos para múltiples conexiones
          connection_limit=1000,
          channel_timeout=120,
          url_scheme='http',
          ident='RRHH Digital Server',
          expose_tracebacks=False)  # No mostrar errores detallados
