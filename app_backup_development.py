...
def convertir_docx_a_pdf_con_libreoffice(docx_path, pdf_path):
    """Convierte DOCX a PDF usando Microsoft Word (más confiable)"""
    ...
    try:
        ...
        # Guardar como PDF (Formato 17 = wdFormatPDF)
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print("✅ SISTEMA LISTO - REALIZADO POR MIRIAN YOLANDA GONZALEZ")
