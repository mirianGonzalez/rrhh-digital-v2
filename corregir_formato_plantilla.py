...
print("=" * 50)
print("🚀 CORRIGIENDO FORMATO de la plantilla de DDJJ...")
print("=" * 50)
...
print(f"📁 Corrigiendo: {plantilla_path}")
...
print("=" * 50)
print(f"✅ Plantilla CORREGIDA guardada exitosamente")
